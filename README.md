...
- 选中军团处境读板：ViewModel 只读聚合当前选中军团的战线压力、威胁热区、脚下控区、编制、军议、机动和将令信号，情报面板用小卡说明压力、机会和下一步，不新增命令队列、评分或自动执行
